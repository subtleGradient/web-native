...
/** @typedef {{ id: string, type: JsonCanvasNodeType, x: number, y: number, width: number, height: number, color?: string, text?: string, file?: string, subpath?: string, url?: string, label?: string, background?: string, backgroundStyle?: JsonCanvasBackgroundStyle }} JsonCanvasNode */
/** @typedef {{ id: string, fromNode: string, fromSide?: JsonCanvasSide, fromEnd?: JsonCanvasEnd, toNode: string, toSide?: JsonCanvasSide, toEnd?: JsonCanvasEnd, color?: string, label?: string }} JsonCanvasEdge */
/** @typedef {{ nodes?: JsonCanvasNode[], edges?: JsonCanvasEdge[] }} JsonCanvasDocument */
...
export class JsonCanvasElement extends HTMLElement {
  ...
  /** @returns {{ nodes: JsonCanvasNode[], edges: JsonCanvasEdge[] }} */
  toCanvasDocument() {
    /** @type {JsonCanvasNode[]} */
    const nodes = []
    /** @type {JsonCanvasEdge[]} */
...
export class JsonCanvasNode extends HTMLElement {
  ...
  #render() {
    ...
    const section = document.createElement(
      this.type === "group" ? "section" : "article",
    )
    section.className = `node node--${this.type}`
    section.setAttribute("part", "node")
    section.dataset.type = this.type
    ...
    chip.textContent = this.type

    const title = document.createElement("span")
    title.className = "node__title"
    title.textContent = getNodeTitle(this)
    ...
    if (this.type === "text") renderMarkdownLite(body, this.text)
    if (this.type === "file") renderFileNode(body, this)
    if (this.type === "link") renderLinkNode(body, this)
    if (this.type === "group") renderGroupNode(section, body, this)
...
/** @param {Element} element @param {JsonCanvasNode} node */
...
/** @param {Element} element @param {JsonCanvasEdge} edge */
...
/** @param {Node} parent @param {string} text */
...
/** @param {HTMLElement} body @param {JsonCanvasNode} node */
...
/** @param {HTMLElement} section @param {HTMLElement} body @param {JsonCanvasNode} node */

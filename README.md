...
- `src/ai.web/` adds BYOK AI client helpers plus `openai-client`, `openai-key-field`, and `openai-result` elements.
- `src/ai-broker.webapp/` contains the Bun-native localhost broker runners used by AI demos and chat webapps.
